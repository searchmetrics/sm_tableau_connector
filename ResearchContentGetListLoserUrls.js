function getResearchContentGetListLoserUrlsSchema() {
	return {
		id: "ResearchContentGetListLoserUrls",
		alias: "Research Content  List Loser Urls",
		columns: [
			{
				id: "url",
				alias: "url",
...
function transformResearchContentGetListLoserUrlsData(data){
	var collectedData = [];
console.log(data);
