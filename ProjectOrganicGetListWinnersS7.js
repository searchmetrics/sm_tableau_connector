function getProjectOrganicGetListWinnersS7Schema() {
	return {
		id: "ProjectOrganicGetListWinners",
		alias: "Project Organic List Winners",
		columns: [
...
function transformProjectOrganicGetListWinnersS7Data(data){
	var collectedData = [];
